 ...
 * 
 * NOTE: This file is duplicated in functions/storage/keyGenerator.ts for Workers
 * Both should be kept in sync. Consider extracting to a shared package in the future.
 */
